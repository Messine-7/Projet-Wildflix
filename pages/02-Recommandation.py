...
#Création d'un compteur pour jonction selection et classement
...
if selection == 0:
    ...
    st.markdown(f'<p style="color: #6495ED; font-family:Oswald; font-size: 32px; text-align: center;"> VEUILLEZ SELECTIONER 3 FILMS</p>', unsafe_allow_html=True)
    ...
    if len(clicked_list) <= 2  : 
        st.markdown(f'<p style="color: #6495ED; font-family:Oswald; font-size: 32px; text-align: center;"> RESTE {3-len(clicked_list)} FILMS A SELECTIONNER</p>', unsafe_allow_html=True)  
        
    if len(clicked_list) > 2 :
        st.markdown(f'<p style="color: #6495ED; font-family:Oswald; font-size: 32px; text-align: center;"> CLIQUEZ DANS L\'ONGLET CLASSEMENT POUR VOIR LA RECOMMANDATION </p>', unsafe_allow_html=True)
...
if selection == 1 :
    ...
    if len(clicked_list) < 3 :
        st.markdown(f'<p style="color: #0000FF;font-family:Oswald; font-size: 25px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; VEUILLEZ SELECTIONNER {3-len(clicked_list)} FILMS DANS L\'ONGLET SELECTION</p>', unsafe_allow_html=True)
    ...
    if switch == 0 or switch == -1 :
        ...
        with selecteur:
            ...
            if len(clicked_list) > 0 :
                ...
                titres = np.append(titres,'"Arry potter et le chibre des secret"')
            # Création de la barre de recherche avec suggestions
            option = st.selectbox("",
                titres)
        ################################################## PORTE SECRETE  #############################################################   
        
        if option == '"Arry potter et le chibre des secret"' :
            img1,sep,img2,sep,img3,sep,img4,sep,img5,sep,img6,sep, = st.columns([2,1,2,1,2,1,2,1,2,1,2,1])
            
            with img1:
                st.image("https://image.noelshack.com/fichiers/2023/21/5/1685071675-xxx.jpg")
                st.write("Retourne-moi, c'est meilleur")
            with img2:
                st.image("https://image.noelshack.com/fichiers/2023/21/5/1685071675-xxx.jpg")
                st.write("L'amour au bureau")
            with img3:
                st.image("https://image.noelshack.com/fichiers/2023/21/5/1685071675-xxx.jpg")
                st.write("Équation à un inconnu")
            with img4:
                st.image("https://image.noelshack.com/fichiers/2023/21/5/1685071675-xxx.jpg")
                st.write('Sunsex Boulevard')            
            with img5:
                st.image("https://image.noelshack.com/fichiers/2023/21/5/1685071675-xxx.jpg")
                st.write('Barbara et les fines braguettes')
            with img6:
                st.image("https://image.noelshack.com/fichiers/2023/21/5/1685071675-xxx.jpg")
                st.write('La Ceinture de chasteté')                
